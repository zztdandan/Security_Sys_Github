...
namespace AppBox.Model
{
    ...
    /// 风险数据审核信息
    /// </summary>
    [Table("SAFE.TR_TRISK02")]
    public class TR_TRISK02
    {
        [Key]
        [Required]
        [Display(Name = "风险数据审核主键"), Column(TypeName = "NVARCHAR2"), MaxLength(8)]
        public string REC_ID { get; set; }

        /// <summary>
        /// 这个主键每条风险数据的历史、现在、审核共享同一个风险主键
        /// </summary>
        [Display(Name = "对应风险主表主键")]
        public int TRISK01 { get; set; }
